...
# wpt.wp_track(model_name, wind_flag=1, wind_speed=5, wind_dir=45, wave_flag=1, wave_height=2, wave_period=15, wave_dir=0, npoints=n, x_wp=xwp, y_wp=ywp, psi0=psi0, traj_str='cardiod_stbd', xdes=xdes, ydes=ydes)
...
# wpt.wp_track(model_name, wind_flag=1, wind_speed=6, wind_dir=270, wave_flag=1, wave_height=3, wave_period=10, wave_dir=270, npoints=n, x_wp=xwp, y_wp=ywp, psi0=psi0, traj_str='eight_bottom', xdes=xdes, ydes=ydes)
